...
public class Main72 {
	...
	public static void main(String[] args) {
		 ...
		 * 중간고사 이전에 배운 빨간눈 초파리의 뒷다리 털의 개수를 구하는 방법을 이용하여, 파인애플 껍질의 두께를 구하는 공식을 과학적인 근거와
		 * 함께 A4용지 10장 이상으로 제출하시오. [30%]
		...
		int L=sc.nextInt(); //성우의 현재 위치에서 민건이의 집까지의 거리
		
		if(L%5==0) { //성우가 1분에 이동할 수 있는 거리 => 5
